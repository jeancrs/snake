...
class MeusTestes(unittest.TestCase):
    ...
    def testTrata_tecla(self):
        self.assertEqual(trata_tecla_cobra(Cobra(50, 5, 200, 0, 1, [], 20),pg.K_LEFT),Cobra(50, -5, 200, 0, 1, [], 20))
        self.assertEqual(trata_tecla_cobra(Cobra(50, 5, 200, 0, 1, [], 20), pg.K_RIGHT),Cobra(50, 5, 200, 0, 1, [], 20))
        self.assertEqual(trata_tecla_cobra(Cobra(50, 0, 200, 5, 1, [], 20), pg.K_UP),Cobra(50, 0, 200, -5, 1, [], 20))
        self.assertEqual(trata_tecla_cobra(Cobra(50, 0, 200, -5, 1, [], 20), pg.K_DOWN), Cobra(50, 0, 200, 5, 1, [], 20))
